...
%With the MNIST dataset, a speedup by a factor of roughly four can be achieved when using four processors, yet increasing beyond this does not give any noticeable gains.
...
%\bibitem{no4} Wiki AdaBoost

%\bibitem{MNIST} Yann LeCun MNIST
